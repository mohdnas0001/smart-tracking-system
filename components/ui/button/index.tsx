  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow transform hover:scale-105 transition-bounce shadow-elegant",
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-glow transform hover:scale-105 transition-bounce",
        university: "bg-primary text-primary-foreground border-2 border-accent hover:bg-primary-hover hover:border-accent-light shadow-card",
      },
      size: {
